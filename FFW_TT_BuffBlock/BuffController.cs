    ...
    class BuffController
    {
        ...
        public void RefreshWheels(ModuleWheels wheels, float rpm)
        {
            ...
            foreach (ManWheels.Wheel wheel in value_Wheels)
            {
                ...
                Console.WriteLine(6);
                int iunno2 = (int)field_AttachedId.GetValue(wheel); // Keep this, this works
                ...
                /*var iunno3 = (Array)field_WheelState.GetValue(iunno);
                Console.WriteLine(8);
                //iunno10.SetValue(iunno, torque);
                Console.WriteLine(iunno3);
                Console.WriteLine(9);
                Type structType = Type.GetType("ManWheels.AttachedWheelState");
