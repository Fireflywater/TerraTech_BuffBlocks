...
namespace FFW_TT_BuffBlock
{
    public class ModuleBuff : Module
    {
        ...
        // Valid floats: "WeaponCooldown", "WeaponRotation", "WeaponSpread", "WeaponVelocity", "WeaponDamage"...
        // Valid floats: "WheelsRpm", "WheelsBrake", "WheelsTorque", "WheelsGrip", "WheelsSuspension"...
        // Valid floats: "HoverForce", "HoverRange", "HoverDamping"...
        // Valid floats: "BoosterBurnRate", "REMOVEDShieldRadiusREMOVED", "DrillDps", "EnergyOps", "EnergyStoreCap", "ItemPickupRange", "ItemProSpeed"...
